...
def get_arguments():
    ...
    args.add_argument('-w', '--weight_path', help='link to weight path', default="./weights/yolov3.backup")
    args.add_argument('-i', '--image_path', help='link to image file')
    args.add_argument('-cf', '--config_path', help='link to config path', default="./cfg/yolov3.cfg")
